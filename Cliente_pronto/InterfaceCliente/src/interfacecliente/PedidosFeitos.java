...
public class PedidosFeitos {
    ...
    public PedidosFeitos(int qnt_X_salada, int qnt_X_burger, int qnt_Cachorro_quente, int qnt_Misto_quente, int qnt_Salada_de_frutas, int qnt_Refrigerante, int qnt_Suco_natural) {
